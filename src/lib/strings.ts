...
const en = {
  ...
  noWorkers: 'No workers found', addSite: 'Add Site',
  ...
  shift: 'Shift', absent: 'Absent', advance: 'Advance (₹)',
  ...
  errorLoading: 'Error loading', deleteConfirm: 'Delete this? Cannot be undone.',
  personalInfo: 'Personal Info', selectSite: 'Select Site',
  selectWorker: 'Select Worker', date: 'Date',
  cash: 'Cash', online: 'Online', none: 'None',
